(function() {
  ...
  const pages = [
    ...
    { name: "Inventory", href: "https://hustle-trap.blogspot.com/p/inventory.html?m=1" },
  ...
  footer.innerHTML = `
    <div style=\"margin-bottom:6px;\">
      <button onclick=\"window.top.location.href='https://hustle-trap.blogspot.com/p/burner-os_8.html?m=1'\" 
